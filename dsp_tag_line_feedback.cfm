...
<br><br>			
<li><strong>TAG LINE</strong>: Highlights a unique feature of the product or service in an engaging way.</li>
 <br><br>
...
<cfif url.primary eq 1> 
	<cfinclude template="includes/dsp_rating_instructions.cfm">
		...
		<cfoutput>
	<form name="business" action="act_tagline_names.cfm?be=#url.be#&cid=#url.cid#&feedback=1<cfif url.e eq 1>&e=1</cfif>&primary=#url.primary#&top_num=#url.top_num#&fid=#url.fid#&uuid=#url.uuid#" method="post">
		</cfoutput>
		
			<cfif names.recordcount eq 0>
				<tr>
					<td>
						<strong>There are currently no tagline names.</strong>
					</td>
				</tr>
			<cfelse>
