...
<br><br>			
<li><strong>ENDORSEMENT</strong>: An outside recommendation to bring credibility to the business.</li>
 <br><br>
...
<cfif url.primary eq 1> 
	<cfinclude template="includes/dsp_rating_instructions.cfm">
		...
		<cfoutput>
	<form name="business" action="act_rtb_names.cfm?be=#url.be#&cid=#url.cid#&feedback=1<cfif url.e eq 1>&e=1</cfif>&primary=#url.primary#&top_num=#url.top_num#&fid=#url.fid#&uuid=#url.uuid#" method="post">
		</cfoutput>
		
			<cfif names.recordcount eq 0>
				<tr>
					<td>
						<strong>There are currently no Endorsement names.</strong>
					</td>
				</tr>
			<cfelse>
