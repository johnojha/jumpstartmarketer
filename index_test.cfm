...
<body leftmargin="0" topmargin="0"  <cfif fa eq "home">bgcolor="F2F6F9"<cfelse><cfif bg eq 0>bgcolor="000000"<cfelse>bgcolor="FFFFFF"</cfif></cfif>>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" height="618" <cfif bg eq 0>bgcolor="000000"<cfelse>bgcolor="FFFFFF"</cfif>>
<tr><td width="133" height="74"><cfif bg eq 1><img src="images/HOME_PAGE_top_left.jpg"><cfelse><img src="images/HOME_PAGE_top_left_blk.jpg"></cfif></td><td width="100%" height="74" <cfif bg eq 0>bgcolor="000000"<cfelse>bgcolor="FFFFFF"</cfif> valign="top"><cfif bg eq 1><img src="images/HOME_PAGE_header_V3.jpg"><cfelse><img src="images/HOME_PAGE_header_V3_blk.jpg"></cfif></td></tr>
 
  <tr><td width="133" height="79" valign="top" align="center"><cfif bg eq 1><img src="images/HOME_PAGE_left.jpg"><cfelse><img src="images/HOME_PAGE_left_blk.jpg"></cfif><!--- <cfinclude template="menu.cfm"> ---></td> 
     <td width="700" height="600" valign="top" rowspan="4" colspan="2">
...
<cfswitch expression="#fa#">
    ...
    <tr><td width="133" height="392" valign="top" <cfif bg eq 1>background="images/HOME_PAGE_menu.jpg"<cfelse>background="images/HOME_PAGE_menu_blk.jpg"</cfif>><cfinclude template="menu_left.cfm"></td>
