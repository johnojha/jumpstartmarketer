...
<cfoutput>	
			<tr> 
				...
				<font color="green">
					...
					Please locate your #replace(ucase(url.be),"_"," ","All")# below and click "Upload" 
					<br><br>
...
<cfif url.big eq 1>
			<tr> 
				<td bgcolor="FFFFCC">
					<font color="red"><b>Your #replace(ucase(url.be),"_"," ","All")# is too large in file size. Please resize to be under 200k.</b></font>
				</td>
			</tr>
</cfif>
<cfif url.update eq 1>
			<tr> 
				<td bgcolor="FFFFCC">
					<font color="red"><b>Your #replace(ucase(url.be),"_"," ","All")# number <cfoutput>#(url.uc - 1)#</cfoutput> has been uploaded.</b></font>
				</td>
			</tr>
</cfif>
<cfif url.delete eq 1>
			<tr> 
				<td bgcolor="FFFFCC">
					<font color="red"><b>Your #replace(ucase(url.be),"_"," ","All")# has been deleted.</b></font>
				</td>
			</tr>
</cfif>
<cfif url.nojpg eq 1>
			<tr> 
				<td bgcolor="FFFFCC">
					<font color="red"><b>Your #replace(ucase(url.be),"_"," ","All")# has to be in the .jpg format. Please save it as a .jpg.</b></font>
				</td>
			</tr>
</cfif>
<cfif url.resize eq 1>
			<tr> 
				<td bgcolor="FFFFCC">
					<font color="red"><b>Your #replace(ucase(url.be),"_"," ","All")# needs to be less than or equal to <cfif url.be eq "key_graphic">600<cfelse>400</cfif> pixels width & less than or equal to <cfif url.be eq "key_graphic">600<cfelse>200</cfif> pixels height. Please resize it and try again.</b></font>
				</td>
			</tr>
</cfif>
</cfoutput>	
	...
	<cfoutput>
			...
			<tr> 
				<td>
				<font color="green">Please upload #replace(ucase(url.be),"_"," ","All")# number <cfoutput>#url.uc#</cfoutput>.</font>
				<br><br>
		...
		<strong>#replace(ucase(url.be),"_"," ","All")#:</strong> <input type="file" name="upload_image"> <br><br>
	...
	<cfelse>
		<cfoutput>
			<tr> 
				<td>
					<font color="green"><b>Please review your 6 #replace(ucase(url.be),"_"," ","All")#s below.</b></font>
					...
					<cfif url.email eq 1>
					<br><br>
						<font color="green">***</font> Please enter email addresses and contact names of the "Experts" below, that this excercise will be sent to. <font color="green">***</font>
					</cfif>
				</td>
			</tr>	
		</cfoutput>
