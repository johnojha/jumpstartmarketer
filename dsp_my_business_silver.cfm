	...
	<cfquery name="b" datasource="#application.dsn#"> 
        ...
        <cfif graphic_presentation_uploads.recordcount gte 3 AND 2 eq 1>
 		...
 		<!---Display row for Generic Descriptor--->
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=generic_descriptor&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_generic_descriptor.jpg" border="0"></a>
				</td>
			</tr>        
		...
		<!---Display row for BRAND--->
			<tr>
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=brand&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_brand.jpg" border="0"></a>
				</td>
			</tr>
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=brand_logo&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_brand_logo.jpg" border="0"></a>
				</td>
			</tr>
...
<!--- 		<cfif b.no_sub_brand neq 1>
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=sub_brand&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_sub_brand.jpg" border="0"></a>
				</td>
			</tr>
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=sub_brand_logo&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_sub_brand_logo.jpg" border="0"></a>
				</td>
			</tr>
		</cfif> --->
			...
			<tr>		
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=benefit&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_benefit.jpg" border="0"></a>
				</td>
			</tr>
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=attributes&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_attributes.jpg" border="0"></a>
				</td>
			</tr>
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=tag_line&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_tag_line.jpg" border="0"></a>
				</td>
			</tr>
...
<!--- 			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=rtb&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_rtb.jpg" border="0"></a>
				</td>
			</tr> --->
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=key_graphic&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_key_graphic.jpg" border="0"></a>
				</td>
			</tr>
			...
			<tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=graphic_presentation&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_graphic_presentation.jpg" border="0"></a>
				</td>
			</tr>
			...
			<!--- <tr>			
				...
				<td valign="top" bgcolor="FFFFFF">
					<a href="index.cfm?fa=elements_silver&be=eye_tracking_study&bg=1&sentnew=0&#shaquerystring#" class="bodylink"><img src="images/headlines_eye_tracking_study.jpg" border="0"></a>
				</td>
			</tr> --->
