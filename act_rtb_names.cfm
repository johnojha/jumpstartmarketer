...
http://jumpstartmarketer.com/dsp_rtb_feedback.cfm?cid=#client.cid#&feedback=1&be=#form.be#&e=1
...
<cfif form.fieldnames eq 0>
		<cfoutput>
			<cflocation url="dsp_rtb_feedback.cfm?radio=1&be=#url.be#&primary=#url.primary#&top_num=#url.top_num#&cid=#url.cid#&uuid=#url.uuid#">
		</cfoutput>
    </cfif>
...
The Jumpstart Marketer Team					
   ...
   <cfset url.primary = url.primary + 1>
					...
					<cfoutput>
						<cflocation url="dsp_rtb_feedback.cfm?update=1&be=#url.be#&primary=#url.primary#&top_num=#url.top_num#&cid=#url.cid#&uuid=#url.uuid#">
					</cfoutput>
...
<cfelse>
	...
	<cfset choiceList = "1,2,3,4,5,6">
		...
		<cfoutput>
			<cflocation url="dsp_rtb_names.cfm?be=#url.be#&sub=1">
		</cfoutput>
