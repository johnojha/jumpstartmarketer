...
function validateThis(rtb)
{

  if (rtb.choice_1.value == "")
  {
    alert("Please choose a Reason to Believe");
    rtb.choice_1.focus();
    return (false);
  }
  
  if (rtb.choice_2.value == "")
  {
    alert("Please choose a Reason to Believe");
    rtb.choice_2.focus();
    return (false);
...
<!--- 			<tr> 
				<td  align="left" colspan="2" height="310" width="100%" valign="top" class="white14" >
					<table class="white14" cellspacing="0" border="0" width="100%">
						<tr>
							...
							<td width="623">
								<img src="images/rtb_def.jpg">
							</td>
						</tr>			
						<tr>
							<td width="530" valign="top" colspan="2">
								<img src="images/rtb_text.jpg"><br>
								  <div align="center"> <a href="index.cfm?fa=rtb_cont&bg=1" class="yellowlink">Continue</a><br></div>					
							</td>
		...
		<form name="rtb" action="act_elements.cfm" method="post" onsubmit="return validateThis(this)">
			<tr>		  
				<td align="center">
			 ...
			 <tr>		  
				<td align="center" class="bodytext" colspan="2">
					Listed below are the ENDORSEMENT names that have gone through the "Bake Off" phases. 
					<br><br>
					Please choose Three ENDORSEMENTS for your product or service to begin the Connectics process.	("rating" - higher score the better, 7 being best.)	
				</td>
			</tr>	
			<tr>
				<td align="center">	
				...
				<td valign="middle" align="left">
					...
					<br><br><br>
					<input type="hidden" name="business_element" value="rtb"> 
					
					<input type="submit" value=" Submit Reasons To Believe "> 
				</td>	  
			 </tr>
		</form>	
			 <tr>
