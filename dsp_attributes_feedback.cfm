...
<font color="green">***</font> PLEASE <strong>REVIEW</strong> THE MARKETING TERMS BELOW <font color="green">***</font>
<br><br>			
<li><strong>BENEFIT</strong>: Represents what consumers get out of using this product or service.</li>
 <br>
<li><strong>ATTRIBUTE</strong>: A product characteristic that supports the BENEFIT.</li> 
<br><br>				
...
<cfif url.primary eq 1> 
	<cfinclude template="includes/dsp_rating_instructions.cfm">
         ...
         <cfif business.benefit neq "">
      		<tr>
            	<td align="center">
					<font color="333333">BENEFIT:</font> <cfoutput><font size="+3"><strong>#business.benefit#</strong></font></cfoutput>
					<br><br>
    			</td>
            </tr>
		 </cfif> 
		...
		<cfoutput>
	<form name="business" action="act_attributes_names.cfm?be=#url.be#&cid=#url.cid#&feedback=1<cfif url.e eq 1>&e=1</cfif>&primary=#url.primary#&top_num=#url.top_num#&fid=#url.fid#&uuid=#url.uuid#" method="post">
		</cfoutput>
		
			<cfif names.recordcount eq 0>
				<tr>
					<td>
						<strong>There are currently no attributes.</strong>
					</td>
				</tr>
			<cfelse>
