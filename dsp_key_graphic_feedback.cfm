...
<br><br>			
<li><strong>KEY GRAPHIC</strong>: The main graphic or picture used on the packaging of a product.</li>
 <br><br>
              ...
              <cfif names.order_num eq url.primary>
				<tr>
					...
					<br>
							...
							<img src="images/key_graphic/#url.cid#/#names.element_text#" border="0">  
