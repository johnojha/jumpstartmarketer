...
<cfinclude template="includes/back_link.cfm">
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="3" class="black14" class="print">
			...
			<form name="business" action="act_rtb_names.cfm?be=#url.be#&phase=#url.phase#" method="post">
			<tr> 
				<td>
				<font color="green">
				
				<cfif url.phase eq 1>
					Please enter your six Endorsements below. 
					<br><br>
					<font color="red">NOTE:</font> Your Endorsements should be no longer than one sentence long.
						<br><br>
					<br><br>					
					Then click "Submit"
					<br><br>
...
<cfif phase eq 1>
			...
			<cfif names.recordcount neq 0>
				<tr> 
					<td bgcolor="CCCCCC">
						Below are your Current <b>Endorsements</b>.
						<br><br>
						<font color="red">NOTE:</font> You must have <strong>six</strong> Endorsements.
						<br><br>
			...
			<tr> 
				<td>
					...
					1). <input type="text" size="50" name="choice_1" maxlength="150">
						<br><br>
					2). <input type="text" size="50" name="choice_2" maxlength="150">
						<br><br>
					3). <input type="text" size="50" name="choice_3" maxlength="150">
						<br><br>
					4). <input type="text" size="50" name="choice_4" maxlength="150">
						<br><br>
					5). <input type="text" size="50" name="choice_5" maxlength="150">
						<br><br>
					6). <input type="text" size="50" name="choice_6" maxlength="150">
					<br><br>
				</td>
			</tr>
			...
			<cfif names.recordcount lt 6>
				<tr> 
					<td bgcolor="CCCCCC">
						<font color="red">NOTE:</font> You must have <strong>six</strong> Endorsements.
						<br><br>
						Please go to the <a href="dsp_rtb_names.cfm?be=#url.be#&email=1&phase=1" class="bakeofflink">PHASE 1 Exercise</a> and enter your six Endorsements.
					</td>
				</tr>
				<cfabort>	
			<cfelse>
